...
<body>
    ...
    <section id="company-community-service-projects">
        ...
        <ul>
            <li>Design and development of a small CAM analyzer including the programming
            <li>Natural and Forced Frequency Analysis for 3-Axis Milling Machine to Improve Stiffness, presented at Advanced Manufacturing Processes in WSU, 2023.
            <li>Potato Processing Plant Facility Planning and Design for BiT, 2022
            <li>Product design and Stress analysis using ANSYS for Ethio-Engineering Group, 2021.
            <li>Micro-dairy equipment Design for the Amhara Dairy Platform, 2021
            <li>Design of HDPE & PVC pipe puller machine for Amhara Pipe Factory, 2020
            <li>Degradation on Energy Conversion, 2020
        </ul>
    </section>
